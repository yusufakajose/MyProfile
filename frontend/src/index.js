...
const getDesignTokens = (mode) => ({
  ...
  typography: {
    ...
    subtitle1: { fontWeight: 500, lineHeight: 1.7 },
    subtitle2: { fontWeight: 500, lineHeight: 1.6 },
    body1: { fontSize: '1rem', lineHeight: 1.7, letterSpacing: '0.00938em' },
    body2: { fontSize: '0.875rem', lineHeight: 1.6, letterSpacing: '0.01071em' },
    button: { fontWeight: 600, textTransform: 'none', letterSpacing: '0.05em' },
